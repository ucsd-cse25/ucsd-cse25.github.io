...
::::{admonition} 📝 HW1 – Due: Tue, Jan 13, **1:59 PM PT** (before class)
:icon: false
:open: false
:class: danger
...
1. Go to the link above and scroll to the **Sign in** section.
2. Click **Sign in through your institution**.
3. Under **Find Your Organization**, enter or select  
   **University of California – San Diego (Library, OpenAthens)**.
4. Log in using your UCSD account.
...
- Upload a **PDF** of your summary to **Gradescope** under `HW1`

**Late policy**

- Up to **one week late** accepted
:::{admonition} Note on GenAI tools
:icon: false
:open: false
:class: tip
...
:::
:::{admonition} GenAI Summary (SPOILER ALERT!)
:icon: false
:open: false
:class: info
...
::::{admonition} 📝 HW2 – Due: Tue, Jan 20, **1:59 PM PT** (before class)
:icon: false
:open: false
:class: danger
...
- Upload a **PDF** of your summary to **Gradescope** under `HW2`
...
Complete Programming Assignment 1 (PA1).
...
- Submit on Gradescope under `PA1`
...
Complete Programming Assignment 2 (PA2).
...
Complete Programming Assignment 3 (PA3).
...
- Submit on Gradescope under `PA3`
