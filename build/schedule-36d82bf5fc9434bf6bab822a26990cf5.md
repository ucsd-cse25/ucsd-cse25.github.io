...
**Overview**
Notes:
- We'll go over PA 1, Final Project Proposals, and PA 2
- [Slides](https://docs.google.com/presentation/d/1xsUR9Iz-rvHIKe6hlZKQhdEyfYWOCH5NYAEvWr6hEIM/edit?usp=sharing)
:::
...
::::{admonition} 📖 In-Class: Thu, Feb 18
:icon: false
:open: false
:class: warning
...
- Upload a PDF of the completed `Worksheet 11` to Gradescope under `In-Class – Week 7 Thursday`
...
:::{admonition} 💬 Discussion: Mon, Feb 23
:icon: false
:open: false
:class: note
...
**Overview**
Notes:
- We'll go over Final project, PA 2, and PA3.
...
- [Slides](https://docs.google.com/presentation/d/1IOPkkNfz6BV9IhndtUq2Yq19ADiLjKPIHhrKnMMZxKo/edit?usp=sharing)
- In discussion, we showed that we can implement a FFNN in pytorch in < 15 lines of code. See demo here: [PA 2 Pytorch Demo](https://github.com/tbonjour-courses/cse25-wi26/blob/main/Discussions/discussion5.ipynb).
:::

:::{admonition} 💻 {ref}`PA3` - N-grams – Due: Tue, Mar 3, **11:59 PM PT**
:icon: false
:open: false
:class: danger
...
::::{admonition} 📖 In-Class: Tue, Feb 24
:icon: false
:open: false
:class: warning
...
- Open on DataHub directly: [Worksheet 12](https://datahub.ucsd.edu/hub/user-redirect/git-pull?repo=https://github.com/tbonjour-courses/cse25-wi26&branch=main&urlpath=lab/tree/cse25-wi26/lectures/08_language_models.ipynb)

- If the DataHub link does not work, [download the notebook from GitHub](https://github.com/tbonjour-courses/cse25-wi26/blob/main/lectures/08_language_models.ipynb) and upload it to DataHub.
...
- Upload a PDF of the completed `Worksheet 13` to Gradescope under `In-Class – Week 8 Thursday`
::::
...
- Open on DataHub directly: [Worksheet 14](https://datahub.ucsd.edu/hub/user-redirect/git-pull?repo=https://github.com/tbonjour-courses/cse25-wi26&branch=main&urlpath=lab/tree/cse25-wi26/lectures/10-reinforcement-learning.ipynb)

- If the DataHub link does not work, [download the notebook from GitHub](https://github.com/tbonjour-courses/cse25-wi26/blob/main/lectures/10-reinforcement-learning.ipynb) and upload it to DataHub.

**Submission**

- Upload a PDF of the completed `Worksheet 14` to Gradescope under `In-Class – Week 9 Tuesday`
::::

::::{admonition} 📖 In-Class: Thu, Mar 4
:icon: false
:open: false
:class: warning
...
- [Final Project](final_project.md): **Progress report** is due today - It counts for 10% of the project grade.
- {ref}`PA4` is due next Tuesday.
- `Studen Evaluations`: Please take some time to complete the [SETs](https://academicaffairs.ucsd.edu/Modules/Evals). I’d love to hear what you enjoyed most about the class and any ideas you have for making it even better next year!
- `Weekly reflections` are due by sunday and count toward your participation grade. Will be released after thursday's class.
...
- Open on DataHub directly: [Worksheet 15](https://datahub.ucsd.edu/hub/user-redirect/git-pull?repo=https://github.com/tbonjour-courses/cse25-wi26&branch=main&urlpath=lab/tree/cse25-wi26/lectures/11-reinforcement-learning-2.ipynb)

- If the DataHub link does not work, [download the notebook from GitHub](https://github.com/tbonjour-courses/cse25-wi26/blob/main/lectures/11-reinforcement-learning-2.ipynb) and upload it to DataHub.
